...
//
    ...
    //
        ...
        static
        {
            Conversation = new PhoneLineFSM_Default.PhoneLineFSM_Conversation("PhoneLineFSM.Conversation", 12);
            Warning = new PhoneLineFSM_Default.PhoneLineFSM_Warning("PhoneLineFSM.Warning", 13);
            Ready = new PhoneLineFSM_Default.PhoneLineFSM_Ready("PhoneLineFSM.Ready", 14);
            Idle = new PhoneLineFSM_Default.PhoneLineFSM_Idle("PhoneLineFSM.Idle", 15);
