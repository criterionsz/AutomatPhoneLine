...
public class PhoneLineSample extends javax.swing.JFrame {
    ...
    private InvalidNumberTransition _ready_invlidNumberTransition = new InvalidNumberTransition("invlidNumber", new String[] {}, new Class[] {});
    ...
    private InvalidNumberTransition _conversation_invlidNumberTransition = new InvalidNumberTransition("invlidNumber", new String[] {}, new Class[] {});
    ...
    private InvalidNumberTransition _warning_invlidNumberTransition = new InvalidNumberTransition("invlidNumber", new String[] {}, new Class[] {});
    ...
    public PhoneLineSample() {
        ...
        _stateMap.put(PhoneLineContext.PhoneLineFSM.Ready, new Transition[] { _ready_onHookTransition, _ready_validNumberTransition, _ready_invlidNumberTransition });
        _stateMap.put(PhoneLineContext.PhoneLineFSM.Conversation, new Transition[] { _conversation_onHookTransition, _conversation_validNumberTransition, _conversation_invlidNumberTransition });
        _stateMap.put(PhoneLineContext.PhoneLineFSM.Idle, new Transition[] { _idle_offHookTransition });
        _stateMap.put(PhoneLineContext.PhoneLineFSM.Warning, new Transition[] { _warning_onHookTransition, _warning_validNumberTransition, _warning_invlidNumberTransition });
